      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="section-title mb-8">EXCELENCIA EN BIENESTAR MASCULINO</h2>
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 mt-8">
              <div className="text-center p-4 bg-pure-white/80 backdrop-blur-sm rounded-xl border border-gold/20">
                ...
                <div className="text-xs text-charcoal font-semibold">CALIDAD PREMIUM</div>
              </div>
              <div className="text-center p-4 bg-pure-white/80 backdrop-blur-sm rounded-xl border border-gold/20">
                <Users className="text-gold mx-auto mb-2" size={24} />
                <div className="text-xs text-charcoal font-semibold">ATENCIÓN PERSONALIZADA</div>
              </div>
              <div className="text-center p-4 bg-pure-white/80 backdrop-blur-sm rounded-xl border border-gold/20">
                <Award className="text-gold mx-auto mb-2" size={24} />
                <div className="text-xs text-charcoal font-semibold">EXPERIENCIA EXCLUSIVA</div>
              </div>
            </div>
          </div>
        </div>
